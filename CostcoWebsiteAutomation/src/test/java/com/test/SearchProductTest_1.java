 ...
 * @author gregshadd
 */
public class SearchProductTest_1 {

    private WebDriver driver;
    private String baseURL;
    private static LoginVO login = null;

    public SearchProductTest_1() {
    }
...
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("Home_Ancillary_0"))).click();
...
//        WebDriverWait wait = new WebDriverWait(driver,30);
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@value='Sign In']"))).click();
//        driver.findElement(By.xpath("//input[@value='Shop as Non-Member']")).click();
//        driver.findElement(By.xpath("//a[@id='cart-d']/div/div")).click();
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Remove"))).click();
//    }
//
//    @Test
...
//        WebDriverWait wait = new WebDriverWait(driver,30);
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("shopCartCheckoutSubmitButton"))).click();
